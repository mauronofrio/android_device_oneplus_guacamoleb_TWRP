...
TARGET_PREBUILT_KERNEL := device/oneplus/guacamoleb/prebuilt/Image.gz-dtb
...
TARGET_RECOVERY_WIPE := device/oneplus/guacamoleb/recovery.wipe
TARGET_RECOVERY_FSTAB := device/oneplus/guacamoleb/recovery.fstab
